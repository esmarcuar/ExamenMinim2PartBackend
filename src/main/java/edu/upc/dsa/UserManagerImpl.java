...
public class UserManagerImpl implements UserManager {
    ...
    //////////////////////////////EXAMEN//////////////////////////////////////////////////////////////777
    @Override
    public User addAbuso(User abuso) {
        String username = abuso.getUsername();
        for (User u : this.userList) {
            if (u.getUsername().equals(username)) {
                logger.info("Abuso " + username + " encontrado");
                return null;
            }
        }
        logger.info("Nuevo abuso: " + abuso);
        this.userList.add(abuso);
        logger.info("Nuevo abuso añadido: " + abuso);
        return abuso;
    }
